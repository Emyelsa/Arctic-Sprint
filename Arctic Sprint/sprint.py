...
class Score:
    ...
    def draw(self):
        ...
        draw_text("High Score: " + str(self.high_score), 28, (19, 130, 98), WIDTH - 60, 20, "topright")
        draw_text("Current Score: " + str(self.score), 28, (19, 130, 98), WIDTH - 60, 65, "topright")
...
class GameOver:
    ...
    def draw(self, screen, high_score, current_score):
        ...
        draw_text("High Score: " + str(high_score), 28, (255, 0, 0), 500, 420, "midtop")
        draw_text("Current Score: " + str(current_score), 28, (255, 0, 0), 500, 450, "midtop")
